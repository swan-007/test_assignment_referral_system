...
class PhonCode(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="phone_sms_code"
    )
...
class AlienInviteCode(models.Model):
    owner_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="owner_code"
    )
    code_user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="alien_invite_code", null=True
    )
